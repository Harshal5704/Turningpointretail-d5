...
export const metadata = {
  title: "Privacy Policy | Turning Point Retail Solutions",
  description: "Read the Privacy Policy for Turning Point Retail Solutions.",
}
    ...
    <div className="animate-fade-in">
      <section className="section-padding bg-gradient-to-br from-blue-50 to-white">
        <div className="container-max">
          <FadeIn>
            <h1 className="heading-primary mb-6 text-center">Privacy Policy</h1>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-max prose prose-lg max-w-4xl mx-auto">
          <FadeIn delay={0.2}>
            <p>
              At Turning Point Retail Solutions, accessible from https://turningpointretail.com, one of our main
              priorities is the privacy of our visitors. This Privacy Policy document contains types of information that
              is collected and recorded by Turning Point Retail Solutions and how we use it.
            </p>
            <p>
            ...
            <p>
              ...
              regards to the information that they shared and/or collect in Turning Point Retail Solutions. This policy
            ...
            <h2>Log Files</h2>
            <p>
              Turning Point Retail Solutions follows a standard procedure of using log files. These files log visitors
            ...
            <h2>Our Advertising Partners Policies</h2>
            <p>
              You may consult this list to find the Privacy Policy for each of the advertising partners of Turning Point
              Retail Solutions.
            </p>
            <p>
              Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
              used in their respective advertisements and links that appear on Turning Point Retail Solutions, which are
            ...
            <p>
              Note that Turning Point Retail Solutions has no access to or control over these cookies that are used by
              third-party advertisers.
            </p>

            <h2>Third Party Privacy Policies</h2>
            <p>
              Turning Point Retail Solutions Privacy Policy does not apply to other advertisers or websites. Thus, we
            ...
            <p>
              Turning Point Retail Solutions does not knowingly collect any Personal Identifiable Information from
