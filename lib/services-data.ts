...
export const services: Service[] = [
  {
    ...
    description:
      "Comprehensive SOPs that streamline operations, ensure consistency, and drive efficiency across all retail touchpoints.",
  ...
  },
  {
    ...
    description:
      "Optimize your store operations with our comprehensive solutions designed to enhance efficiency and customer satisfaction.",
    ...
    process: ["Store Assessment", "Layout Planning", "Implementation Strategy", "Staff Training", "Performance Review"],
  ...
  },
  {
    ...
    description:
      "Comprehensive risk assessment and mitigation strategies to protect your retail business from operational, financial, and market risks.",
  ...
  },
  {
    ...
    description:
      "Data-driven performance optimization strategies that maximize efficiency, profitability, and growth potential.",
  ...
  },
  {
    ...
    slug: "skill-academy",
    description:
      "Comprehensive training programs designed to elevate your team's skills and drive exceptional retail performance.",
  ...
  },
  {
    ...
    description:
      "Transform your retail business with cutting-edge digital solutions that enhance customer experience and operational efficiency.",
  ...
  },
  {
    ...
    description:
      "Create a compelling brand identity that resonates with your target audience and drives customer loyalty.",
  ...
  },
  {
    ...
    description:
      "Harness the power of data analytics to make informed decisions and drive strategic growth in your retail business.",
  ...
  },
  {
    ...
    description:
      "Comprehensive franchise development solutions to scale your retail concept and build a successful franchise network.",
  ...
  },
  {
    ...
    description:
      "Design and implement customer experience strategies that create memorable interactions and drive loyalty.",
  ...
  },
  {
    ...
    description:
      "Strategic market entry planning and execution to successfully launch your retail business in new markets.",
  ...
  },
  {
    ...
    description:
      "Navigate the complexities of international retail expansion with our comprehensive global market entry solutions.",
  ...
  },
  {
    ...
    description:
      "Create compelling visual displays that attract customers, enhance brand image, and drive sales performance.",
  ...
  },
  {
    ...
    description:
      "Leverage artificial intelligence and machine learning to gain deeper insights and optimize your retail operations.",
...
// Export servicesData as a named export for compatibility
